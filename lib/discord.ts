...
const mention = opts.discordUsername ? `@(${opts.discordUsername})` : " ";  
  await sendWebhookCongratulation({
    ...
    content: `:tada:Congratulations **${opts.memberName}** **${mention}** You've earned the **${opts.badgeName}** :trophy: **+${opts.badgePoints}** pts Keep up the good work! <@&885146340487733268> @Linux @everyone`,
      allowed_mentions: {
    parse: ["everyone", "roles", "users"],
  },
    embeds: [
